    ...
    m_syncManager(syncManager)
{
    ...
    const auto router =
        [this](const auto function, const RpcMode routePermissions, const bool isBodyRequired, const bool syncRequired)
    {
    ...
    RpcServer::getBlockTemplate(const httplib::Request &req, httplib::Response &res, const rapidjson::Document &body)
{
    ...
    const auto transactionPrivateKey =
        Utilities::getTransactionPrivateKeyFromExtra(blockTemplate.baseTransaction.extra);
